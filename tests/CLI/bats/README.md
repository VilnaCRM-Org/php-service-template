...
See also the [CI](.githuborkflows/tests.yml) settings for the current test environment and
scripts.
...
The Bats Logo was created by [Vukory](https://www.artstation.com/vukory) ([Github](https://github.com/vukory)) and sponsored by [SethFalco](https://github.com/SethFalco). If you want to use our logo, have a look at our [guidelines](docsource/assets/README.md#Usage-Guide-for-Third-Parties).
